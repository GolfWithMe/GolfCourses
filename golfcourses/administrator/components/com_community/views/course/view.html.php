 ...
 */
class CommunityViewCourse extends JViewLegacy
{
    /**
    ...
    public function display( $tpl = null )
    {
        ...
        JToolBarHelper::title( JText::_('Course'), 'course');
        ...
        //JToolBarHelper::deleteList( JText::_('Are you sure you want to delete this course?') , 'deleteCourse' , JText::_('COM_COMMUNITY_DELETE') );
        ...
        $filter_order       = $mainframe->getUserStateFromRequest( "com_community.course.filter_order",     'filter_order',     'a.Name',   'cmd' );
        $filter_order_Dir   = $mainframe->getUserStateFromRequest( "com_community.course.filter_order_Dir", 'filter_order_Dir', '',         'word' );
    ...
    public function getPublish( &$row , $type , $ajaxTask )
    {
        ...
        $href = '<a class="'.$class.'" href="javascript:void(0);" onclick="azcommunity.togglePublish(\'' . $ajaxTask . '\',\'' . $row->uid . '\',\'' . $type . '\');">';
