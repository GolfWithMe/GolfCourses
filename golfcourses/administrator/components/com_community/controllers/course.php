 ...
 */
class CommunityControllerCourse extends CommunityController
{
...
<?php
    ...
    public function ajaxEditCourse( $courseId )
    {
		$response   = new JAXResponse();
        $model      = $this->getModel( 'course', 'CommunityAdminModel' );
        $course = $model->getSelectCourse($courseId);
		$users = $model->getAllUsers('name');
        ...
        // Escape the output
        //$course->Name    = CStringHelper::escape($course->Name);
...
<table cellspacing="0" class="admintable" border="0" width="100%">
    <tbody>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Course Name'); ?></td>
            <td>
                <input type="text" name="Name" value="<?php echo $course->Name; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Address 1'); ?></td>
            <td>
                <input type="text" name="Address1" value="<?php echo $course->Address1; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Address 2'); ?></td>
            <td>
                <input type="text" name="Address2" value="<?php echo $course->Address2; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('City, State, Zip'); ?></td>
            <td>
                <table cellspacing="0" border="0" width="100%">
                <tr>
                    <td ><input type="text" name="City" value="<?php echo $course->City; ?>" style="width: 200px;" /></td>
                    <td ><input type="text" name="State" value="<?php echo $course->State; ?>" style="width: 75px;" /></td>
                    <td ><input type="text" name="ZipCode" value="<?php echo $course->ZipCode; ?>" style="width: 75px;" /></td>
                 </tr>
                 </table>
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Main Phone'); ?></td>
            <td>
                <input type="text" name="Phone" value="<?php echo $course->Phone; ?>" style="width: 200px;" />
            </td>
        </tr><tr>
            <td class="key" width="100"><?php echo JText::_('Booking Phone'); ?></td>
            <td>
                <input type="text" name="BPhone" value="<?php echo $course->BPhone; ?>" style="width: 200px;" />
            </td>
        </tr><tr>
            <td class="key" width="100"><?php echo JText::_('Main Site URL'); ?></td>
            <td>
                <input type="text" name="URL" value="<?php echo $course->URL; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Booking URL'); ?></td>
            <td>
                <input type="text" name="BURL" value="<?php echo $course->BURL; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Map URL'); ?></td>
            <td>
                <input type="text" name="locMap" value="<?php echo $course->locMap; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Price Range'); ?></td>
            <td>
                <input type="text" name="priceRange" value="<?php echo $course->priceRange; ?>" style="width: 200px;" />
            </td>
        </tr>
        <tr>
            <td class="key" width="100"><?php echo JText::_('Holes'); ?></td>
            <td>
                <input type="text" name="Holes" value="<?php echo $course->Holes; ?>" style="width: 200px;" />
            </td>
        </tr><tr>
            <td class="key" width="100"><?php echo JText::_('Course Type'); ?></td>
            <td>
        ...
        <tr>
            <td class="key"><?php echo JText::_('Manage');?></td>
            <td>
                <select name='ownerid'>
                    <option value='0' <?php echo ($course->ownerid == 0 ) ? ' selected="selected"' : '';?> ><?php echo JText::_('Select User');?></option>
                    <?php
                    foreach($users as $row )
                    {
                        if($course->ownerid==$row->id)  {
...
<input type="hidden" name="option" value="com_community" />
<input type="hidden" name="task" value="savecourse" />
...
<?php
        ...
        $action = '<input type="button" class="btn btn-small btn-primary pull-right" onclick="azcommunity.saveCourse();" name="' . JText::_('COM_COMMUNITY_SAVE') . '" value="' . JText::_('COM_COMMUNITY_SAVE') . '" />';
        $action .= '&nbsp;<input type="button" class="btn btn-small pull-left" onclick="cWindowHide();" name="' . JText::_('COM_COMMUNITY_CLOSE') . '" value="' . JText::_('COM_COMMUNITY_CLOSE') . '" />';
        $response->addScriptCall( 'cWindowActions' , $action );
    ...
    public function saveCourse()
    {
		...
		//print_r($postData);
       	$model      = $this->getModel( 'course', 'CommunityAdminModel' );
		$course = $model->getUpdateCourse($postData);

        $message    = '';
        if( $course )
        {
            $message    = JText::_('Course Updated');
        }
        else
        {
        ...
        $mainframe->redirect( 'index.php?option=com_community&view=course' , $message ,'message' );
    }
