...
class CommunityCoursesController extends CommunityBaseController
{
    var $task;
    var $_icon = 'courses';
    var $_name = 'courses';
    ...
    public function courses()
    {
        ...
        $view = $this->getView('courses', '', $viewType);
    ...
    public function editcourses()
    {
        ...
        echo $view->get('editcourses', $data);
    }
    ...
    public function recresponse()
    {
        ...
        echo $view->get('recresponse', $data);
    }
	
	/**
     * Requestor Close Request
     */
		...
		foreach ( $scheduleList as $rowsche ) {
			...
			foreach ( $accMem as $damem ) {
				...
				if($damem->status==0) {
					...
					$body   = "Hi ".$usr->name." <br /> This is the mail to inform you that. Your friend invited you for Golf-With-Me. <br /><br /> If you are interested, <a href='".JURI::base()."index.php?option=com_community&view=groupschedule'>click here.</a> <br /><br /> Thank You <br />The Golf With Me Team<br /><br /> <img src='".JURI::base()."images/gwmhorlogo2.png'>";
					$mailer->isHtml(true);
